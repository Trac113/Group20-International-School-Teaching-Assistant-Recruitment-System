...
public class ProfileServiceTest {
    ...
    @Test
    public void testUpdateProfileShouldRejectStudentIdContainingSpaces() {
        File profileFile = new File("src/main/resources/data/profiles.json");
        if (profileFile.exists()) {
            profileFile.delete();
        }
        ...
        ProfileService profileService = new ProfileService();
        UserProfile profile = new UserProfile("student_1", "Computer Science", "2024 001", List.of("Java"), "Bio");
