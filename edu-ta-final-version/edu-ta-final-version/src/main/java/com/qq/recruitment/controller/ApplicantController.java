...
public class ApplicantController {
    ...
    private void loadJobs() {
        User currentUser = SessionManager.getInstance().getCurrentUser();
        if (currentUser != null && workloadStatusLabel != null) {
            int current = applicationService.getApplicantWorkload(currentUser.getUsername());
            int max = applicationService.getApplicantMaxWorkload(currentUser.getUsername());
            workloadStatusLabel.setText("My Workload: " + current + "/" + max);
        }
